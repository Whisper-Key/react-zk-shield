...
export class WalletProviderRegistry {
    ...
    localAccount: string;
    constructor(localEnvironment: any, localAccount: string,  auroWalletLib: any, network: string) {
    ...
    getProviderInstances(): IWalletProvider[] {
        ...
        if (this.network === "local") {
            return [new LocalInjectedWallet(this.localEnvironment, this.localAccount, true)];
        } else {
